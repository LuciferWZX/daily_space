import 'package:daily_space/core/extensions/string.dart';
import 'package:daily_space/data/source/github/models/item.dart';

import 'package:daily_space/data/source/github/models/pokemon.dart';
import 'package:daily_space/data/source/local/models/item.dart';

import 'package:daily_space/data/source/local/models/pokemon.dart';
import 'package:daily_space/data/source/local/models/pokemon_gender.dart';
import 'package:daily_space/data/source/local/models/pokemon_stats.dart';
